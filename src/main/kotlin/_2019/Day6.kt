...
fun main() {
    aocRun(puzzleInput) { input ->
        ...
        while (nextObjects.isNotEmpty()) {
            totalOrbits += orbitLevel * nextObjects.size
            nextObjects = nextObjects.mapNotNull { orbits[it]?.toSet() }.flatten()
            orbitLevel++
        }
        return@aocRun totalOrbits
    }
